...
3. Field Naming Conventions:
   - Use descriptive, hierarchical names for fields (e.g., `cc.code.class.ClassName`, `cc.code.function.MethodName`, `cc.code.class.ClassName.function.MethodName`)
   - Common top-level fields: `cc.code.imports`, `cc.code.constants`, `cc.code.class`, `cc.code.function`, `cc.code.main`, `cc.code.tests`

4. Indentation and Structure:
   - Maintain the existing code's indentation when adding CML tags.
   - Ensure CML tags do not have any trailing spaces.

5. Best Practices:
   - Tag all significant code structures (classes, methods, functions, etc.), including nested ones.
   - Create a `cc.metadata` field at the beginning of the file for overall file information, include the programming language as a param [[cc.metadata, params={{language:___}}]]
   - Tag imports, constants, and main code sections separately.
   - Use nested fields for functions within classes.
   - Example:
# [[cc.code.class.ExampleClass]]
class ExampleClass:
# [[cc.code.class.ExampleClass.function.__init__]]
    def __init__(self):
        Initialization code
# [[/cc.code.class.ExampleClass.function.__init__]]

# [[cc.code.class.ExampleClass.function.example_class_function]]
    def example_class_function(self, code: str, language: str) -> str:
        class function code
# [[/cc.code.class.ExampleClass.function.example_class_function]]
# [[/cc.code.class.ExampleClass]]
...
Please add CML tags to this code following the guidelines above. Return only the tagged code without any additional explanation. Literally, just the code.
